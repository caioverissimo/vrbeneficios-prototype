appEC.controller('ContratosPendentesModalController', ['$scope', '$uibModal', '$uibModalInstance', 'activeEstablishment', 'pendingContracts', '$http', function ($scope, $uibModal, $uibModalInstance, activeEstablishment, pendingContracts, $http) {
  $scope.LOADING = false;
